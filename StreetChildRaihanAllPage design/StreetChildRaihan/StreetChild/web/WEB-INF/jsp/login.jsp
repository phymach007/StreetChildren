            ...
            <c:choose>
                <c:when test="${i%4==0}" >
                    ...
                    <div class="item active" style="">
                         ...
                         <h2 class="text-center" style="color: #496054;position: relative;"><c:out value="${items. getOrganizationName()}"/></h2>
                         <p class="text-center" style="color: "> <c:out value="${items.getPost()}"/></p>  
  ...
  <section id="section-createOrg" class="section appear clearfix" style="background-color: #496054">
    ...
    <div class="container" style="position:relative;">
       ...
       <div class="col-sm-7 col-lg-7">
           ...
           <h2 class="text-center" style="color: #c4e3f3"><strong>Organization Information</strong></h2>
