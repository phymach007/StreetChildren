...
<body>
        ...
        <div class="container">
            ...
            <div id="navbar-spy" class="collapse navbar-collapse navbar-responsive-collapse">
               ...
               <a href="/StreetChild/login" style="position: relative;top: -50px;"><input type="button">Logout</a>
        ...
        <div id="banners"></div>
            ...
            <div class= well-lg">
                    <form method = "POST" action = "/StreetChild/PostShow" enctype="multipart/form-data">
...
<textarea  type="text" rows="3" placeholder="Write here" class="form-control image-preview-filename" name="post"></textarea>
<input class="form-control"  name="file" type="file" accept="image/png, image/jpeg,image/gif" onchange="readURL(this);" />
<input type="hidden" name="filename1" value="${file}" />
<img id="blah1" src="data:image/jpg;base64,#"  />

<input class="form-control"  name="file" type="file" accept="image/png, image/jpeg,image/gif" onchange="readURL(this);" />
<input type="hidden" name="filename2" value="${file}" />
<img id="blah2" src="data:image/jpg;base64,#" />

<input class="form-control"  name="file" type="file" accept="image/png, image/jpeg,image/gif" onchange="readURL(this);" />
<input type="hidden" name="filename3" value="${file}" />
<img id="blah3" src="data:image/jpg;base64,#"  />

<input class="form-control"  name="file" type="file" accept="image/png, image/jpeg,image/gif" onchange="readURL(this);" />
<input type="hidden" name="filename4" value="${file}" />
<img id="blah4" src="data:image/jpg;base64,#"  />


<input class="form-control"  name="file" type="file" accept="image/png, image/jpeg,image/gif" onchange="readURL(this);" />
<input type="hidden" name="filename5" value="${file}" />
<img id="blah4" src="data:image/jpg;base64,#"  />
<button type = "submit" name="action1" onclick="sortByDateeeee()" class = "btn btn-block" style="background-color:  #333"><strong style="color: #dbdbdb">Post</strong></button>
          ...
          <div class="row">
           ...
           <c:forEach items="${Final}" var="final"  varStatus ="i">  
...
<!--                       <p><a href="" onclick="clickCounter()" >Like</a> - <a href="#">Share</a></p>
                       <div id="result"></div>
                       -->
                     ...
                     <div class="comment-form" >
                       <form class="form-inline" action="/StreetChild/checkUserInfoUpdate" method="POST">
            ...
            <div class="col-md-3">
                ...
                <div class="thumbnail shadow-depth-4 well" style="background-color: #dbdbdb">
                   ...
                   <c:forEach items="${reviews1}" var="rev">
                       ...
                       <p style="color: #c9302c">Comment: ${rev.getReview()}</p><br>
...
<script type="text/javascript">
        ...
        <%--<div class="container" style="background-color: #111">
            <h1 class="text-center" style="color: #fff">?????????</h1>
                </div>
