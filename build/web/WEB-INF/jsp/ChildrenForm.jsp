         ...
         <div class="row" style="align-content: center">
          ...
          <div class="container" style="position: relative;top:-20px">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right ">
                       ...
                       <li>
                        ...
                        <li class="active"><a href="#"><p>Add Children</p></a></li>
            ...
            <div class="text-center">
                <h1  style=" color: #fff;"><u>Children Form: </u></h1>
                
            
               
                <form method = "POST" action = "/StreetChild/childrenlist">
                    <h5 style="color: white">Name        :</h5><input type="text" name="Name" /> <br>
                    <h5 style="color:white">Age       :</h5><input type="text" name="Age" /><br>
                        ...
                        <%--<a href="/StreetChild/login"><div class="btn" style="position: relative;left: 150px;top: 50px;height: 20px;width: 70px">Create</div>
                                ...
                                <button type="submit" class="btn btn-danger" name="list">Submit</button>
                                </form>
